...
git_url = "git@gitlab.yto.net.cn:YTO-eCommerce/ec-commerce/finance-fms/fms-center.git"
maven_home = "/home/gnosis/apache-maven-3.6.1/bin/mvn"
maven_settings_file_path = "/home/gnosis/apache-maven-3.6.1/conf/yto/settings_baoli.xml"
java_home = "/usr/java/jdk1.8.0_191/bin/java"
java_opt = "-server -Xmx1024M -Xms1024M -XX:MaxMetaspaceSize=512M -XX:MetaspaceSize=512M -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=75 -XX:+UseCMSInitiatingOccupancyOnly -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/root/YTOwebapp"
target_hosts = [["192.168.207.17", "22"]]
app_name = "fms-center"
project_child_path = ""
env = "test"
app_home = "/usr/local/YTOwebapp/$app_name-$env"
branch = "RA20200916155244311"
commit_id = ""
type = "controller"
...
deploy_sleep_seconds = 30
sleep_seconds_after_kill = 30
is_backup = false
to_tag = false
...
maven_install = false
to_deploy = true
deploy_stopping = false
deploy_stopping_timeout_seconds = 1
increment = 

// Copy jar to other hosts.
copy_jar_to_hosts = false
copy_hosts = ""
copy_host_user = ""
copy_host_dir = ""
...
// Parameters with http request input.
with_docker = false
dockerfile_project_dockerfile_name = ""
dockerfile_project_git_url = ""
dockerfile_project_name = get_dockerfile_project_name(dockerfile_project_git_url)
elk_topic = ""
elk_kafka_cluster_list = ""
docker_repo = ""
app_port = 8080
docker_other_params = ""
