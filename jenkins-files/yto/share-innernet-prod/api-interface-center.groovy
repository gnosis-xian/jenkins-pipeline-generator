git_url = "git@10.1.193.100:YTO-eCommerce/ec-commerce/share/share-interface-center.git"
...
java_home = "/usr/local/jdk1.8.0_221/bin/java"
java_opt = "-server -Xmx5440M -Xms5440M -XX:MaxMetaspaceSize=512M -XX:MetaspaceSize=512M -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=75 -XX:+UseCMSInitiatingOccupancyOnly -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/home/yjt/YTOwebapp"
target_hosts = [["10.132.131.191", "22"], ["10.132.131.200", "22"]]
app_name = "interface-center"
env = "prod"
app_home = "/home/yjt/YTOwebapp/$app_name-$env"
branch = "version_1.3"
commit_id = ""
type = "application"
